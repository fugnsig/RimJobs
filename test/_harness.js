...
function loadScripts(relFiles, ctxStubs) {
  ...
  const capture = ['Engine', 'Charts', 'CapabilityEvidence', 'CapacityResolver', 'RequirementRegistry', 'EffectivenessDefinitionRegistry', 'PermissionResolver', 'C4EvaluationContext', 'AvailabilityResolver', 'C4LegacyCompatibility', 'PRESET_BUILDINGS',
