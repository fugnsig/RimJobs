...
function loadScripts(relFiles, ctxStubs) {
  ...
  const capture = ['Engine', 'Charts', 'CapabilityEvidence', 'CapacityResolver', 'RequirementRegistry', 'EffectivenessDefinitionRegistry', 'StructuralEffectivenessContext', 'StructuralSkillResolver', 'StructuralPassionResolver', 'StructuralStatResolver', 'StructuralLearningResolver', 'StructuralEffectivenessResolver', 'TemporalProfileResolver', 'PermissionResolver', 'C4EvaluationContext', 'AvailabilityResolver', 'C4LegacyCompatibility', 'C5LegacyCompatibility', 'PRESET_BUILDINGS',
